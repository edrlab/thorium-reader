...
//         return;
//     }
//     const result = await repository.findAllSortDesc();
//     expect(result.length).toBe(2);
// });
...
//     const result = await repository.findAllSortDesc();
//     expect(result.length).toBe(2);
//     expect(result[0].identifier).toBe(dbDocIdentifier1);
//     expect(result[1].identifier).toBe(dbDocIdentifier2);
// });
...
//         return;
//     }
//     const dbDoc: PublicationDocumentWithoutTimestampable = {
