...
const firebaseMeasurementProtocolQueueSqliteEnabled =
    !["0", "false"].includes((
        process.env.THORIUM_FIREBASE_MEASUREMENT_PROTOCOL_QUEUE_SQLITE_ENABLED ||
        "0"
    ).toLowerCase());
...
const data = {
    ...
    __TH__FIREBASE_MEASUREMENT_PROTOCOL_QUEUE_SQLITE_ENABLED__: JSON.stringify(firebaseMeasurementProtocolQueueSqliteEnabled),
