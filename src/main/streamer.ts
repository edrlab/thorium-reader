...
import { installLcpHandler } from "r2-testapp-js/dist/es6-es2015/src/electron/main/lcp";
import { setupReadiumCSS } from "r2-testapp-js/dist/es6-es2015/src/electron/main/readium-css";
