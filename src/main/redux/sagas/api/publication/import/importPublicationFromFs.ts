...
import { publicationParseFromPathToR2Publication } from "readium-desktop/main/publicationParsePromise";
...
export async function importPublicationFromFS(
    ...
    const r2Publication = await publicationParseFromPathToR2Publication(filePath);
    if (!r2Publication) {
