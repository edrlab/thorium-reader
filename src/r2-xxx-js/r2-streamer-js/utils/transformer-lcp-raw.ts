...
// import { ITransformer } from "@r2-shared-js/transform/transformer";
...
// async function getDecryptedSizeStream(
//     lcpContentKey: Buffer,
...
//                 lcpContentKey, // Buffer.from(contentKey as string, "binary"),
//                 ivBuffer);
...
// export class TransformerLCPRaw implements ITransformer {
...
//         if (!(publication as any)["AES256CBCContentKey"]) {
//             return false;
//         }
...
//             //     ||
//             //     (link.Properties.Encrypted.Profile && /^http:\/\/readium\.org\/lcp\/profile-2\.[0-9]$/.test(link.Properties.Encrypted.Profile))
//             //     )
//             //     )
//             // )
//         ;
...
//         // return transformStream_(publication, link.Href, link.Properties.Encrypted,
//         //         stream, isPartialByteRangeRequest, partialByteBegin, partialByteEnd);

//         // eslint-disable-next-line @typescript-eslint/no-explicit-any
//         const lcpContentKey = (publication as any)["AES256CBCContentKey"] as Buffer;
...
//             try {
//                 cryptoInfo = await getDecryptedSizeStream(lcpContentKey, stream);
//             } catch (err) {
//                 debug(err);
//                 // eslint-disable-next-line @typescript-eslint/prefer-promise-reject-errors
...
//             // Note: assumes lcp.ContentKey has been set (can be undefined)
//             // (this is only for testing the pure JS implementation anyway)
//             lcpContentKey as Buffer, // Buffer.from(contentKey as string, "binary"),
//             ivBuffer);
//         decryptStream.setAutoPadding(false);
