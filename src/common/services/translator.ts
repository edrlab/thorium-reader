...
import * as ptCatalog from "readium-desktop/resources/locales/pt.json";
...
import * as ptLang from "readium-desktop/resources/locale-names/ptLang.json";
...
i18nextInstance.addResourceBundle("pt", "translation", ptLang, true);
