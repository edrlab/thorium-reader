...
// In this TypeScript codebase, this is never actually used as a proper enum type (e.g. "AvailableLanguages.en"),
// but only used from the transpiled Javascript object map (generated by the TS->ES6 compiler),
// so let's use this directly
// so that Object.keys and Object.value<T> can be used with type safety
// export enum AvailableLanguages {
//     en = "English",
//     ......
// }
export const AvailableLanguages: { [lang: string]: string } = {
    en: "English",
    fr: "Français",
    de: "Deutsch",
};
