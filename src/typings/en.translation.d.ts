declare namespace typed_i18n {
  ...
  readonly "storage": {
    readonly "additionalStorage": string,
    readonly "cancel": string,
    readonly "chooseDirectory": string,
    readonly "chooseDirectoryInfo": string,
    ...
    readonly "directoryInfo": string,
    readonly "locations": string,
    readonly "recovery": {
      readonly "canBeRecovered": string,
      readonly "cannotBeRecovered": string,
      readonly "checkAgain": string,
      readonly "checkForRecovery": string,
      readonly "description": string,
      readonly "foundOnDisk": string,
    ...
    readonly "storageConfigured": string,
    readonly "systemStorage": string,
  ...
  (_: "settings.storage.additionalStorage", __?: {}): string;
  (_: "settings.storage.cancel", __?: {}): string;
  (_: "settings.storage.chooseDirectory", __?: {}): string;
  (_: "settings.storage.chooseDirectoryInfo", __?: {}): string;
  (_: "settings.storage.configuration", __?: {}): string;
  (_: "settings.storage.dialog", __?: {}): {
  readonly "continue": string,
  readonly "editDirectory": string,
  readonly "enable": {
    readonly "description": string,
  ...
  (_: "settings.storage.dialog.continue", __?: {}): string;
  (_: "settings.storage.dialog.editDirectory", __?: {}): string;
  (_: "settings.storage.dialog.enable", __?: {}): { readonly "description": string, readonly "title": string };
  (_: "settings.storage.dialog.enable.description", __?: {}): string;
  (_: "settings.storage.dialog.enable.title", __?: {}): string;
  (_: "settings.storage.dialog.remove", __?: {}): { readonly "description": string, readonly "title": string };
  (_: "settings.storage.dialog.remove.description", __?: {}): string;
  (_: "settings.storage.dialog.remove.title", __?: {}): string;
  (_: "settings.storage.dialog.removeDirectory", __?: {}): string;
  (_: "settings.storage.dialog.update", __?: {}): { readonly "description": string, readonly "title": string };
  (_: "settings.storage.dialog.update.description", __?: {}): string;
  (_: "settings.storage.dialog.update.title", __?: {}): string;
  (_: "settings.storage.directoryInfo", __?: {}): string;
  (_: "settings.storage.locations", __?: {}): string;
  ...
  (_: "settings.storage.recovery.canBeRecovered", __?: {}): string;
  (_: "settings.storage.recovery.cannotBeRecovered", __?: {}): string;
  (_: "settings.storage.recovery.checkAgain", __?: {}): string;
  (_: "settings.storage.recovery.checkForRecovery", __?: {}): string;
  (_: "settings.storage.recovery.description", __?: {}): string;
  (_: "settings.storage.recovery.foundOnDisk", __?: {}): string;
  (_: "settings.storage.recovery.loading", __?: {}): string;
  (_: "settings.storage.recovery.title", __?: {}): string;
  (_: "settings.storage.removeDirectory", __?: {}): string;
  (_: "settings.storage.selectDirectory", __?: {}): string;
  (_: "settings.storage.storage", __?: {}): string;
  (_: "settings.storage.storageConfigured", __?: {}): string;
  (_: "settings.storage.systemStorage", __?: {}): string;
  (_: "settings.storage.updateDirectory", __?: {}): string;
  (_: "settings.storage.warning", __?: {}): {
  readonly "1": string,
  readonly "2": string,
  readonly "3": string,
  readonly "4": string,
  ...
  (_: "settings.storage.warning.1", __?: {}): string;
  (_: "settings.storage.warning.2", __?: {}): string;
  (_: "settings.storage.warning.3", __?: {}): string;
  (_: "settings.storage.warning.4", __?: {}): string;
  (_: "settings.storage.warning.title", __?: {}): string;
  (_: "settings.tabs", __?: {}): {
  readonly "appearance": string,
  readonly "general": string,
  readonly "keyboardShortcuts": string,
