...
export default class SearchContainer extends React.Component<SearchContainerProps, SearchContainerState> {

    // How to translate temporarily
    @lazyInject("translator")
    private translator: Translator;

    public constructor(props: SearchContainerProps) {
        super(props);
        this.state = {
            value: "",
            suggestions: [],
    ...
    public render(): React.ReactElement<{}> {
        ...
        const inputProps = {
            placeholder: __("settings.placeholderTag"),
