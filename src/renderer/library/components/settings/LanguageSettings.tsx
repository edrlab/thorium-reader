...
const SelectItem = React.forwardRef(({ children, ...props }: any, forwardedRef) => {
    return (
        ...
        className={stylesSettings.select_language_item}>
            <Select.ItemText>{children}</Select.ItemText>
            <Select.ItemIndicator className={stylesSettings.select_language_icon}>
    ...
    return (
            <section className={stylesSettings.settings_tab_container}>
                ...
                <Select.Root onValueChange={(lang) => props.setLocale(lang)}>
                    <Select.Trigger  className={stylesSettings.select_language_trigger}>
                        <Select.Icon className={stylesSettings.select_language_icon}><SVG ariaHidden={true} svg={LanguageIcon} /></Select.Icon>
                        <Select.Value placeholder={AvailableLanguages[currentLanguage]} />
                        <Select.Icon className={stylesSettings.select_language_icon}><SVG ariaHidden={true} svg={ChevronDown} /></Select.Icon>
                    </Select.Trigger>
                    <Select.Portal>
                        <Select.Content className={stylesSettings.select_language_content}>
