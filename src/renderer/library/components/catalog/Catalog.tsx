...
class Catalog extends React.Component<IProps, undefined> {
    ...
    public render(): React.ReactElement<{}> {
        ...
        const secondaryHeader = <span style={{display: "flex", justifyContent: "end", alignItems: "end", height: "65px", borderBottom: "1px solid var(--color-medium-grey)", paddingBottom: "30px"}}><PublicationAddButton /></span>;
        return (
            <LibraryLayout
