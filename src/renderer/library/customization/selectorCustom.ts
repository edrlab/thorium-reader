...
export const profileSelectorListTargetsProfileScreenWithCustomParser = (selectorText: string): boolean =>
    splitSelectorList(selectorText).every(selectorTargetsProfileScreen);
