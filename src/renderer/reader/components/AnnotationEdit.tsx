    ...
    >
        ...
        <div role="group">
            ...
            <div className={stylesReader.annotation_form_textarea_buttons}>
                ...
                {displayFromReaderMenu
                    ? <button type="submit" className={stylesButtons.button_secondary_blue} aria-label="save" onClick={(e) => { e.preventDefault(); save(colorObj, textAreaRef?.current?.value || "", drawTypeSelected); }}>{__("dialog.save")}</button>
                    : <Popover.Close type="submit" className={stylesButtons.button_secondary_blue} aria-label="save" onClick={(e) => { e.preventDefault(); save(colorObj, textAreaRef?.current?.value || "", drawTypeSelected); }}>{__("dialog.save")}</Popover.Close>
                }
            </div>
        {/* </div> */}
    </form>;
