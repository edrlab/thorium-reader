...
npm ci --ignore-scripts --foreground-scripts --min-release-age=3 --allow-git=root --cpu=x64 && cd node_modules/electron && DEBUG=@electron/get* force_no_cache=true npm_config_arch=x64 ELECTRON_INSTALL_ARCH=x64 node install.js --cpu=x64 && cd - &&\
